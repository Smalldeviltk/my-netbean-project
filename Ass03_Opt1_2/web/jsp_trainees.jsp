...
<body>
    ...
    <form style="width: 80%" name="frmTraines">
        ...
        <% 
            String _sAcccount = request.getParameter("txtAccount").toString().trim();
            String _sFirstName = request.getParameter("txtFirstName").toString();
            String _sLastName = request.getParameter("txtLastName").toString();
            String _sEmail = request.getParameter("txtEmail").toString();
            
            session.setAttribute("sAccount", _sAcccount);
...
//                Connection con = DriverManager.getConnection("jdbc:odbc:accTraine");
        ...
        <fieldset class="hiden">
            ...
            <input type="button" name="btUpdate" value="Update" onclick="javascript:location.href = 'jsp_input.jsp'"/>
        </fieldset>
    </form>    
</body>
</html>