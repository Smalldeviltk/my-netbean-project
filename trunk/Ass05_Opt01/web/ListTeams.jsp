...
<%@page import="com.qlydb.action.TeamDao"%>
                    ...
                    <div class="navbar-inner">
                        <div class="container">
                            <ul class="nav">
                                ...
                                <div class="btn-group">
                                    <s:a data-hover="dropdown" cssClass="btn dropdown-toggle btn-large menu-btn-active" href="danhsach">
                    ...
                    <section class="span12">
                        <div class="panel panel-primary" style="margin-left: 10%;margin-right: 10%">
                            <div class="panel-heading">
                                <h3 class="panel-title">List of teams</h3>
                            </div>
                            <div class="panel-body">
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${teamList}" var="obj">
                                        <tr>
                                            <td><c:out value="${obj.idteam}">${obj.idteam}</c:out></td>
                                            <td><c:out value="${obj.nameTeam}">${obj.nameTeam}</c:out></td>
                                            <td><c:out value="${obj.diem}">${obj.diem}</c:out></td>
                                            <td><c:out value="${obj.hieuso}">${obj.hieuso}</c:out></td>
                                            </tr>
                                    </c:forEach>
                                </table>
                            </div>
